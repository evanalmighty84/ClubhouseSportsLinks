...
const HOST2 = "https://serpapi.com/search.json?engine=google&q=sports technology&hl=en&gl=us&tbm=nws&api_key=5e69ec18cf0447512781635d11c1f5f093573c73246e236f5cfe9784ed165f49";
const HOST3 = "https://serpapi.com/search.json?engine=google&q=sports technology stock&hl=en&gl=us&tbm=nws&api_key=5e69ec18cf0447512781635d11c1f5f093573c73246e236f5cfe9784ed165f49";
				...
				setTimeout(async () => {
					try {
						...
						const completion = await openai.completions.create({
							...
							prompt: `Can you summarize or expound on this in about 300 words with paragraphs and indention  ${articleExtractorResponse.data.data.description}`,
							temperature: 0.7,
							max_tokens: 400,
						});
						...
						try {
							const response = await axios.get(`https://serpapi.com/search.json?engine=google&q=${articleExtractorResponse.data.data.title}&hl=en&gl=us&tbm=vid&api_key=5e69ec18cf0447512781635d11c1f5f093573c73246e236f5cfe9784ed165f49`);
				...
				setTimeout(async () => {
					try {
						...
						try {
							const completion = await openai.completions.create({
								model: 'gpt-3.5-turbo-instruct',
								prompt: `expound on this snippet in about 300 words with paragraphs and indention ${articleExtractorResponse2.data.data.description}`,
								temperature: 0.7,
								max_tokens: 400,
							});
						...
						try {
							const response = await axios.get(`https://serpapi.com/search.json?engine=google&q=${articleExtractorResponse2.data.data.title}&hl=en&gl=us&tbm=vid&api_key=5e69ec18cf0447512781635d11c1f5f093573c73246e236f5cfe9784ed165f49`);
							const videoResults = response.data.video_results;
				...
				setTimeout(async () => {
					try {
						...
						try {
							const completion = await openai.completions.create({
								model: 'gpt-3.5-turbo-instruct',
								prompt: `expound on this snippet in about 300 words with paragraphs and indention ${articleExtractorResponse3.data.data.description}`,
								temperature: 0.7,
								max_tokens: 400,
							});
						...
						try {
							const response = await axios.get(`https://serpapi.com/search.json?engine=google&q=${articleExtractorResponse3.data.data.title}&hl=en&gl=us&tbm=vid&api_key=5e69ec18cf0447512781635d11c1f5f093573c73246e236f5cfe9784ed165f49`);
							const videoResults = response.data.video_results;
