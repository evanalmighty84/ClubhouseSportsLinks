...
const NetworkStats = ({}) => {
    ...
    return (
        <>
            <div
                className="flex flex-row auto-cols-max border border-[#3F4346] divide-x divide-[#3F4346] rounded-md bg-black opacity-80 h-9 ">
                ...
                {error === "no-error" &&
                    <>
                        <div
                            className="group  inline-flex items-center gap-2 text-xs text-customGray-250 basis-1/2 w-32">
                            <DownloadIcon/>
                            {downloadSpeed} MBPS
                        </div>
                        <div
