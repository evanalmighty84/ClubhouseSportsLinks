                        ...
                        >
                                  ...
                                  <span className="w-6 mr-2 flex items-center justify-center">
                                    {selectedMic?.label === item?.label && (
                                        <CheckIcon className='h-5 w-5'/>
                                                ...
                                                {micOn ? <div
                                                        className="my-1 pr-2 text-white flex flex-1 w-full text-left mb-2 pl-4">
                          ...
                          <span className="mr-4 mt-1">
                            <TestMic/>
                                                        ...
                                                        <div
                                                            className="w-36 mt-3 bg-gray-450 rounded-full h-1 dark:bg-gray-700">

                                                            <div className="bg-white opacity-50 h-1 rounded-full"
                                                                 style={{width: `${volume as any / 256 * 100}%`}}></div>
                                                        </div>

                                                        {recordingStatus == "inactive" &&
                                                            <button className='w-16 h-7 text-xs rounded ml-5 bg-gray-450'
                                                    ...
                                                    :
                                                    <div
                                                        className=' text-[#747B84] flex flex-1 items-center w-full  mb-2 pl-5'>
                                                        <TestMicOff/>
