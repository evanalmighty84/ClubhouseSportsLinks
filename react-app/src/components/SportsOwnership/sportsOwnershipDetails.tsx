                ...
                <div className="head">
                    <div className="collumns">
                        <div className="collumn" style={{background: 'linear-gradient(to right,#2f2f2f,#008B00)',padding:'0px'}}>
                            ...
                            <hr/>
                            <p style={{textAlign: 'left',color:'white'}}>{selectedArticle.NILNoGif ? selectedArticle.NILNoGif.content : selectedArticle.NIL.content}</p>
                        </div>
                    </div>
